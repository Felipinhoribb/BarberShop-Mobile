...
export class DetailsPage implements OnInit {
  ...
  constructor(private routeActive: ActivatedRoute) {
    ...
    this.barber = this.getBarberById(this.id);
  }

  ngOnInit() {
  }

  getBarberById(id: number) : Barber {          //Método que obtém o objeto pelo id do Barbeiro e retorna o objeto encontrado.
    for (const barber of this.listBarbers) {
      if (barber.idBarber === id) {
        return barber;
      }
    }
